...
[V_flat,boundMesh,flattener]=flatten_disk(V,F,cones);

flatteningInfo = struct('V_flat',V_flat,'boundMesh',boundMesh,'flattener',flattener);
dataFunctions =  [];
...
if strcmp(method,'e_interp')
    sz = params.sz;
    f=functions(:,1);
    [V_flat_merged, T_merged] = make_tiling_interp(V_flat, F);
